...
readonly class RectorDataProvider implements AnalysisReportDataProviderInterface
{
    ...
    {
        return 'rector_analysis';
    }

    public function getTemplatePath(string $format): string
    {
        return match ($format) {
            'html' => 'html/partials/main-report/rector-analysis-table.html.twig',
            'md' => 'md/partials/main-report/rector-analysis-table.md.twig',
